...
def render_gacha_screen():
	...
	{"レア": "N", "名": "新品のノート", "言": "まだ何も書いていない。これからだ。"},
	{"レア": "N", "名": "カップラーメン", "言": "夜食で食べるか、我慢するか。"},
	{"レア": "N", "名": "インスタアカウント", "言": "もはや就活するなら消してしまえ"},
	{"レア": "N", "名": "掃除機", "言": "部屋の汚さは心の汚さ。はやく掃除しろ"},
